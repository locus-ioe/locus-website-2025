...
const SingleBlog = () => {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>{blog?.title} | LOCUS Blogs</title>
        ...
        <meta property="og:image" content={featuredImage || `${window.location.origin}/assets/blog/blog_default.png`} />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:site_name" content="LOCUS 2026" />
        ...
        <meta name="twitter:image" content={featuredImage || `${window.location.origin}/assets/blog/blog_default.png`} />
        
        {/* Additional Meta Tags */}
        <meta property="article:author" content={blog?.author} />
        <meta property="article:published_time" content={blog?.pubDate} />
      </Helmet>
